...
export default function CheckOutTotalPrice({ payment, orderInfo }) {
    ...
    return (
        <div className='mb-2 '>
            ...
            <Button variant="contained" className='w-100 d-flex align-items-center mx-auto p-1  bg-warning rounded-4 mt-3 mb-3 border-0 justify-content-center fs-4' onClick={handleOrder}>結&nbsp;&nbsp;&nbsp;&nbsp;帳</Button>
        </div>
    )
}

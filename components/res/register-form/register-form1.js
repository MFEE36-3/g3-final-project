...
export default function RegisterForm() {
  ...
  const testGoogleAPI = () => {
    fetch(
      `https://maps.googleapis.com/maps/api/geocode/json?address=台灣${shop.city}${shop.area}${shop.fulladdress1}&key=AIzaSyBcRKBsOJ9t8gpHAfAC_ZbY4eNTyDlBlMQ`
    )
      .then((r) => r.json())
      .then((obj) => {
  ...
  return (
    <>
      ...
      <div className="container container-sm-fluid">
        <div className="row">
          {/* <form className={`${styles.backGroundColor} col-xxl-8 container-fluid col-sm-12 border border-danger rounded-4 border-3`} */}
          <form
            className={`${styles.backGroundColor} ${styles.title} col-xxl-8 container-fluid col-sm-12  rounded-4 border-3`}
            // onSubmit={handleSubmit}
          >
            <h1
              className={`${styles.title} d-flex justify-content-center fw-bold mt-3`}
            >
              商家註冊
            </h1>
            ...
            <div className="col-xxl-mx-5">
              ...
              <div className="error me-5 pe-5 fs-5 fw-bold d-flex justify-content-center">
                {errors.name}
              </div>
              ...
              <div className="res_cate mx-5 d-flex justify-content-start align-items-center mt-3">
                ...
                >
                  ...
                  {res_cateOptions.map((v, i) => {
                    return (
                      <option key={i} value={v} onChange={handleResCate}>
                        {v}
                      </option>
                    );
                  })}
              ...
              <div
                className={`d-flex justify-content-between mt-1 col-xxl-3 col-sm-6 mx-5 ${styles.addressDisplay}`}
                // style={``}
              >
                <select
                  name="city"
              ...
              <div className="d-flex justify-content-between mt-3 mx-5">
                <div className="">
                  <div
                    className={`d-flex justify-content-start  align-items-center ${styles.addressDisplay}`}
                  >
                    <input
                      type="text"
                      className={`${styles.input} form-control`}
              ...
              <div className="error pe-5 mx-5 fs-5 fw-bold d-flex justify-content-start">
                {errors.fulladdress}
              </div>
              ...
              <div className="error mx-5 pe-5 fs-5 fw-bold d-flex justify-content-start">
                {errors.open_time}
              </div>
                ...
                <div className="">
                  ...
                  <div className="d-flex justify-content-between mt-2">
                    {openDayOptions.map((v, i) => {
                      return (
                        <label key={i} className={`me-4 ${styles.openDays}`}>
                          <input
                            className=""
                            type="checkbox"
                            value={v}
              ...
              <div className={`${styles.verifyinput} mx-5`}>
                <div className="d-flex align-items-center">
                  ...
                  <div className="ms-3 fw-bold" style={{ color: 'black' }}>
                    {sendMailHint}
                  </div>
                </div>
              </div>
              <div
                ...
                style={{
                  color: `${showMessage == '驗證碼正確!' ? 'green' : 'red'}`,
                }}
              >
                {showMessage}
              </div>
              <div className="error me-5 ms-5 pe-5 fs-5 fw-bold d-flex justify-content-start">
                {errors.verifyEmail}
              </div>
              <hr />

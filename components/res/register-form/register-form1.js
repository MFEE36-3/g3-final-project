  ...
  return (
    <>
      ...
      <div className="container container-sm-fluid">
        <div className="row">
          <form
            className={`${styles.backGroundColor} col-xxl-8 container-fluid col-sm-12 border border-black rounded-4 border-4`}
            ...
            <div className="col-xxl-mx-5">
              ...
              <div className="password mx-5 d-flex justify-content-start align-items-center mt-3">
                ...
                <div class="input-group mb-3 d-flex flex-row mb-3">
                  ...
                  <button
                    type="button"
                    className="btn btn-warning btn-outline-secondary"
                    style={{ fontSize: '12px' }}

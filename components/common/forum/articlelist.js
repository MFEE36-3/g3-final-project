...
export default function Articlelist({
  ...
  return (
    <>
      {articles.map((c, i) => {
        const hasLiked = memberLike.some(item => item.forum_sid === c.forum_sid);
        return <div key={c.forum_sid} className={styles.right}>
          <div className={styles.container}>
            ...
            {hasLiked ? (
              ...
              <FiHeart className={styles.icon} onClick={(e) => { clickHeartEvent(e, c.forum_sid) }} /> 
              : 
              <BiSolidHeart className={styles.icon} onClick={(e) => { clickHeartEvent(e, c.forum_sid) }} />} */}

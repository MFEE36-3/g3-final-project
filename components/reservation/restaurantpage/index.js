...
export default function ReservationPage({ row, date, setDate, time, setTime, person, setPerson, seat, setSeat, memo, setMemo, shoppingCart, setShoppingCart, togodate, setTogodate, togotime, setTogotime }) {
        ...
        <>
            <div className='position-relative'>
                ...
                {page === '訂位' ? <Reservation row={row} date={date} setDate={setDate} time={time} setTime={setTime} person={person} setPerson={setPerson} seat={seat} setSeat={setSeat} memo={memo} setMemo={setMemo} />
                    : <Togo row={row} shoppingCart={shoppingCart} setShoppingCart={setShoppingCart} togodate={togodate} setTogodate={setTogodate} togotime={togotime} setTogotime={setTogotime} />}
            </div>
        </>
    )
}

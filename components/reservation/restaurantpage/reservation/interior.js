...
export default function InteriorPic() {
    ...
    return (
        <div className='d-flex justify-content-center'
            ...
            <svg className={`${style.svgicon} ${style.svg6}`} width="98" height="97" viewBox="0 0 98 97" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${style.svgicon} ${style.svg8}`} width="103" height="145" viewBox="0 0 103 145" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${style.svgicon} ${style.svg8s}`} width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${style.svgicon} ${style.svg41}`} width="80" height="65" viewBox="0 0 80 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${style.svgicon} ${style.svg42}`} width="80" height="65" viewBox="0 0 80 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="23" width="33.8144" height="65" fill="#D9D9D9" />
                <rect x="61.0312" y="6.61133" width="18.9691" height="20" fill="#D9D9D9" />
                <rect y="39.1113" width="18.9691" height="20" fill="#D9D9D9" />
                <rect x="61.0312" y="39.1113" width="18.9691" height="20" fill="#D9D9D9" />
            ...
            <svg className={`${style.svgicon} ${style.svg43}`} width="80" height="65" viewBox="0 0 80 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="23" width="33.8144" height="65" fill="#D9D9D9" />
                <rect x="61.0312" y="6.61133" width="18.9691" height="20" fill="#D9D9D9" />
                <rect y="39.1113" width="18.9691" height="20" fill="#D9D9D9" />
                <rect x="61.0312" y="39.1113" width="18.9691" height="20" fill="#D9D9D9" />
            ...
            <svg className={`${style.svgicon} ${style.svg4s1}`} width="143" height="143" viewBox="0 0 143 143" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${style.svgicon} ${style.svg4s2}`} width="143" height="143" viewBox="0 0 143 143" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="29.0742" y="42.5078" width="18" height="18" transform="rotate(-45 29.0742 42.5078)" fill="#D9D9D9" />
                <rect x="87.7617" y="101.199" width="18" height="18" transform="rotate(-45 87.7617 101.199)" fill="#D9D9D9" />
                <rect x="87.7617" y="41.8008" width="18" height="18" transform="rotate(-45 87.7617 41.8008)" fill="#D9D9D9" />
                <rect x="29.0742" y="100.492" width="18" height="18" transform="rotate(-45 29.0742 100.492)" fill="#D9D9D9" />
            ...
            <svg className={`${style.svgicon} ${style.svg21}`} width="30" height="77" viewBox="0 0 30 77" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${style.svgicon} ${style.svg22}`} width="30" height="77" viewBox="0 0 30 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="54" width="30" height="30" transform="rotate(-90 0 54)" fill="#D9D9D9" />
                <circle cx="15" cy="68" r="9" transform="rotate(-90 15 68)" fill="#D9D9D9" />
                <circle cx="14.5" cy="9.5" r="9" transform="rotate(-90 14.5 9.5)" fill="#D9D9D9" />
            </svg>

            <svg className={`${style.svgicon} ${style.svg23}`} width="30" height="77" viewBox="0 0 30 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="54" width="30" height="30" transform="rotate(-90 0 54)" fill="#D9D9D9" />
                <circle cx="15" cy="68" r="9" transform="rotate(-90 15 68)" fill="#D9D9D9" />
                <circle cx="14.5" cy="9.5" r="9" transform="rotate(-90 14.5 9.5)" fill="#D9D9D9" />
            </svg>

            <svg className={`${style.svgicon} ${style.svg24}`} width="30" height="77" viewBox="0 0 30 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="54" width="30" height="30" transform="rotate(-90 0 54)" fill="#D9D9D9" />
                <circle cx="15" cy="68" r="9" transform="rotate(-90 15 68)" fill="#D9D9D9" />
                <circle cx="14.5" cy="9.5" r="9" transform="rotate(-90 14.5 9.5)" fill="#D9D9D9" />
            </svg>

            <svg className={`${style.svgicon} ${style.svg2s1}`} width="78" height="31" viewBox="0 0 78 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={`${style.svgicon} ${style.svg2s2}`} width="78" height="31" viewBox="0 0 78 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="54.25" y="30.25" width="30" height="30" transform="rotate(-180 54.25 30.25)" fill="#D9D9D9" />
                <circle cx="68.25" cy="15.25" r="9" transform="rotate(-180 68.25 15.25)" fill="#D9D9D9" />
                <circle cx="9.75" cy="15.75" r="9" transform="rotate(-180 9.75 15.75)" fill="#D9D9D9" />
            </svg>

            <svg className={`${style.svgicon} ${style.svg2s3}`} width="78" height="31" viewBox="0 0 78 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="54.25" y="30.25" width="30" height="30" transform="rotate(-180 54.25 30.25)" fill="#D9D9D9" />
                <circle cx="68.25" cy="15.25" r="9" transform="rotate(-180 68.25 15.25)" fill="#D9D9D9" />
                <circle cx="9.75" cy="15.75" r="9" transform="rotate(-180 9.75 15.75)" fill="#D9D9D9" />
            </svg>

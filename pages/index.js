...
const commodity_data = [
  {
    ...
    img_url:
      'https://i1.momoshop.com.tw/1676619225/goodsimg/0010/515/725/10515725_O_m.webp',
    price: 59,
  },
  {
    item_name: '100%天然蘋果汁100ml*10入/盒',
    img_url:
      'https://i3.momoshop.com.tw/1678464800/goodsimg/0010/915/585/10915585_O_m.webp',
    price: 579,
  },
  {
    item_name: '100％蘋果汁(天然蘋果汁 非濃縮還原汁 100ml*10包)',
    img_url:
      'https://i3.momoshop.com.tw/1689147656/goodsimg/0009/932/182/9932182_O_m.webp',
    price: 568,
  },
  {
    item_name: '10種米果120g',
    img_url:
      'https://i3.momoshop.com.tw/1685423444/goodsimg/0007/906/874/7906874_O_m.webp',
    price: 99,
  },
  {
    item_name:
      '12M+ 寶寶蔬果泥（80ml/包）(12M+ 果泥 綜合果汁 膳食纖維 韓國銷售前10)',
    img_url:
      'https://i2.momoshop.com.tw/1689148901/goodsimg/0011/243/707/11243707_O_m.webp',
    price: 63,
  },
  {
    item_name: '14袋綜合豆果子餅乾341g',
    img_url:
      'https://i3.momoshop.com.tw/1663780246/goodsimg/0010/075/747/10075747_O_m.webp',
    price: 228,
  },
  {
    item_name: '14袋綜合豆果子餅乾3包組(341g/包)',
    img_url:
      'https://i2.momoshop.com.tw/1677784679/goodsimg/0010/107/945/10107945_O_m.webp',
    price: 609,
  },
  {
    item_name:
      '2入組 食品級冰箱專用密封盒保鮮盒 650ml+1000ml(冷藏收納盒 密封保鮮 醃漬盒)',
    img_url:
      'https://i3.momoshop.com.tw/1689148187/goodsimg/0010/596/716/10596716_O_m.webp',
    price: 351,
  },
  {
    item_name: '3L 熟食干貝 250g',
    img_url:
      'https://i3.momoshop.com.tw/1688363549/goodsimg/0011/084/968/11084968_O_m.webp',
    price: 565,
  },
  {
    item_name:
      '4入冰箱四分格PP收納保鮮盒-S/L(微波/冷藏/冷凍 透明分隔分類 蔥薑蒜肉醬料食物材 方形好堆疊)',
    img_url:
      'https://i3.momoshop.com.tw/1689146847/goodsimg/0009/814/221/9814221_O_m.webp',
    price: 449,
  },
  {
    item_name:
      '4包共400顆-飽滿元寶手工水餃-高麗菜、韭菜、玉米任選(上班族15分鐘上菜最好的選擇/年菜配菜)',
    img_url:
      'https://i1.momoshop.com.tw/1688363144/goodsimg/0005/867/386/5867386_O_m.webp',
    price: 887,
  },
  {
    item_name: '5香乖乖50g',
    img_url:
      'https://i1.momoshop.com.tw/1688450543/goodsimg/0008/455/907/8455907_O_m.webp',
    price: 36,
  },
];
    ...
    <>
      ...
      <div className={styles.container} id="mainpage_container">
        <div className={styles.first_page} id="firstPage">
          ...
          <Image
            src={chocoCookie}
            className={styles.chocoCookie}
            alt="chocoCookie with site name"
            priority
          />
        </div>
        ...
        <ul className={styles.sidebar}>
          ...
          {auth.account ? (
            ...
            <Link href="./login" className={styles.linkOffstyle}>
              <li className={styles.liBtn}>前往登入</li>
            </Link>
          )}
        </ul>
        ...
        <div className={`${styles.buy_for_me}`} id="buyForMe">
          <div className={`${styles.buyme_left}`}>
            <Image
              src={walkbag_line}
              className={`${styles.walkbag_line}`}
              alt="walkbag_line"
            />
            <Image
              src={filled_walkbag_middle}
              className={styles.filled_walkbag_middle}
              alt="filled_walkbag_middle"
            />
            <Image
              src={filled_walkbag_last}
              className={styles.filled_walkbag_last}
              alt="filled_walkbag_last"
            />
          ...
          <div className={`${styles.buyme_right}`}>
            ...
            <div className={styles.sausage_container}>
              ...
              <Image
                ...
                className={
                  sausage_open === false
                    ? styles.sausage_left
                    : styles.sausage_left_active
                }
                onClick={() => setSausage_Open(true)}
              />
              <Image
                alt="sausageRight"
                src={sausageRight}
                className={
                  sausage_open === false
                    ? styles.sausage_right
                    : styles.sausage_right_active
                }
                onClick={() => setSausage_Open(true)}
              />
            </div>
            <div className={styles.goBtn}>
              <Link
                href={
                  search !== '' ? `/buyforme?keyword=${search}` : '/buyforme'
                }
              >
                <Btn text="馬上GOGO!" />
              </Link>
          ...
          <div className={styles.shopmall_container}>
            ...
            <div className={styles.random_btn}>
              <Btn
                text="隨機商品"
                onClick={() => {
                  setRandomvalue(Math.round(7 * Math.random()));
                }}
              />
            </div>
          ...
          <div className={styles.bgnews}>
            ...
            <div className={styles.newsBtn}>
              <Btn
                ...
                style={{ boxShadow: '0 1px 3px 1px red' }}
              />
            </div>
          </div>
